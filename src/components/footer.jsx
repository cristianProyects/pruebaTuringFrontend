...
return(
    <div className="bg-footer">
            ...
            <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5">
                ...
                <h5 className="text-green">Secciones</h5>
                <ul className="nav flex-column ">
                    <li className="nav-item mb-2"><a href="#inicio" className="nav-link p-0 text-white">Inicio</a></li>
                    <li className="nav-item mb-2"><a href="#productos" className="nav-link p-0 text-white">Productos</a></li>
                    <li className="nav-item mb-2"><a href="#evolucion" className="nav-link p-0 text-white">Evolucion</a></li>                    
                    <li className="nav-item mb-2"><a href="#somos" className="nav-link p-0 text-white">Somos</a></li>
                </ul>
                </div>
            </footer>
            </div>
